...
export const sampleProperties: Property[] = [
  ...
  },
  {
    ...
    {
    id: 'sample-7',
    title: 'Villa de lujo con piscina infinita y vistas panorámicas',
    description:
      'Impresionante villa de 450m² en lo alto de la colina con vistas de 360 grados. Cinco dormitorios en suite, cocina gourmet, bodega climatizada y cine en casa. La piscina infinita de 20 metros parece fundirse con el horizonte. Jardín mediterráneo de 1200m² con zona de barbacoa y huerto ecológico.',
    propertyType: 'casa',
    operationType: 'venta',
    price: 1250000,
    address: 'Camino de la Cima 7',
    city: 'Marbella',
    bedrooms: 5,
    bathrooms: 5,
    area: 450,
    amenities: ['piscina', 'jardin', 'garage', 'seguridad', 'gimnasio', 'terraza', 'aire_acondicionado', 'calefaccion'],
    images: [
      'https://placehold.co/800x600/ec4899/ffffff?text=Villa+Principal',
      'https://placehold.co/800x600/ec4899/ffffff?text=Piscina+Infinita',
      'https://placehold.co/800x600/ec4899/ffffff?text=Salon+Principal',
      'https://placehold.co/800x600/ec4899/ffffff?text=Cocina+Gourmet',
      'https://placehold.co/800x600/ec4899/ffffff?text=Dormitorio+Master',
      'https://placehold.co/800x600/ec4899/ffffff?text=Jardin',
      'https://placehold.co/800x600/ec4899/ffffff?text=Terraza',
    ],
  ...
  {
    id: 'sample-8',
    title: 'Ático duplex con terraza privada en el corazón de la ciudad',
    description:
      'Extraordinario ático duplex de 300m² con terraza privada de 150m². Planta baja con salón de doble altura, cocina de diseño y tres dormitorios. Planta superior con suite principal, vestidor y terraza con jacuzzi. Vistas a los tejados históricos de la ciudad. Acabados de primera calidad.',
    propertyType: 'apartamento',
    operationType: 'venta',
    price: 890000,
    address: 'Calle Serrano 88, Ático',
    city: 'Madrid',
    bedrooms: 4,
    bathrooms: 3,
    area: 300,
    amenities: ['terraza', 'ascensor', 'seguridad', 'aire_acondicionado', 'amueblado', 'garage'],
    images: [
      'https://placehold.co/800x600/f97316/ffffff?text=Atico+Duplex',
      'https://placehold.co/800x600/f97316/ffffff?text=Terraza+Jacuzzi',
      'https://placehold.co/800x600/f97316/ffffff?text=Salon+Doble+Altura',
      'https://placehold.co/800x600/f97316/ffffff?text=Cocina',
      'https://placehold.co/800x600/f97316/ffffff?text=Suite+Principal',
      'https://placehold.co/800x600/f97316/ffffff?text=Vestidor',
    ],
